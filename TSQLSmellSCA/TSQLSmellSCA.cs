...
RuleScope = SqlRuleScope.Model)] // This rule targets the whole model
    ...
    [LocalizedExportCodeAnalysisRule(TSQLSmellSCA051.RuleId,
        RuleConstants.ResourceBaseName, // Name of the resource file to look up displayname and description in
        RuleConstants.TSQLSmell_RuleName51, // ID used to look up the display name inside the resources file
        null,
        // ID used to look up the description inside the resources file
        Category = RuleConstants.CategorySmells,
        RuleScope = SqlRuleScope.Model)] // This rule targets the whole model
    public sealed class TSQLSmellSCA051 : SqlCodeAnalysisRule
    {

        public const string RuleId = "Smells.SML051";
