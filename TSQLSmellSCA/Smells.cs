...
namespace TSQLSmellSCA
{
    public class Smells
    {
        ...
        private readonly RaiseErrorProcessor _raiseErrorProcessor;
        ...
        public Smells()
        {
            ...
            _raiseErrorProcessor = new RaiseErrorProcessor(this);
        ...
        public DeclareVariableProcessor DeclareVariableProcessor
        {
            get { return _declareVariableProcessor; }
        }
           ...
           String stmtType = FragmentTypeParser.GetFragmentType(fragment);
            ...
            switch (stmtType)
            {
                ...
                case "RaiseErrorStatement":
                    _raiseErrorProcessor.RaiseErrorDefinition((RaiseErrorStatement)fragment);
                    break;
            }
        }
